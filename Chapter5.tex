...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): could not find function "{}thesis\_fill"{}}}\end{kframe}
\end{knitrout}
...
{\centering \subfloat[\label{fig:movtFig1}]{\includegraphics[width=0.45\textwidth]{figure/movtFig-1} }
\subfloat[\label{fig:movtFig2}]{\includegraphics[width=0.45\textwidth]{figure/movtFig-2} }
