...
\chaptermark{Population structure and pathogen richness in wild bats}
...
\chaptermark{Population structure and pathogen richness in theoretical populations}
\label{ch:sims1}
\include{Chapter2}
...
\chaptermark{A comparison of population size, density and colony size}
\label{ch:sims2}
\include{Chapter4}
