...
\chapter{A mechanistic model to compare the importance of in  terrelated population measures: population size, population density and colony size}{This work was conducted in collaboration with Kate Jones and Hilde Wilkinson-Herbots.}
\chaptermark{A comparison of population size, population density and colony size}
\label{ch:sims2}
\include{Chapter4}
...
I led the writing of the manuscript with coauthors.
}
