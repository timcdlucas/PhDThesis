...
Given finite host resources and competition between parasites, there must be limits to pathogen richness.
In particular, in the presence of competition we can expect competitive exclusion \cite{bremermann1989competitive, martcheva2013competitive, ackleh2003competitive, ackleh2014robust, turner2002impact}.
Analytically tracteable, simple models show that dividing a population into more than one patch can allow coexistence instead \cite{qiu2013vector, allen2004sis, nunes2006localized}.
However, in the ecological literature the opposite expectation is often held: that unstructured populations promote the spread of new pathogens and thus increase pathogen richness \cite{nunn2003comparative, morand2000wormy, poulin2014parasiteCh3}.
...
{\centering \includegraphics[width=0.8\textwidth]{figure/boxplot-2} 

}

\caption[Histogram of number of subspecies]{Histogram of number of subspecies. 
It is clear that more species have fewer subspecies.}\label{fig:boxplot2}
\end{figure}
