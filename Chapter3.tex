...
A number of other potentially important factors (body mass, range size and study effort) were included as additional independant variables.
...
I have completed this analysis using the number of subspecies a bat species has and estimates of gene flow separately as measures of population structure.
