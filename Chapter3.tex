...
Species that host many pathogen species are more likely to be the source of a novel zoonotic disease.
Unfortunately, the factors that influence pathogen richness in animal species are still poorly understood.
%
%
...
Epidemiological theory suggests that population structure can promote pathogen richness by reducing competition.
...
Both of these measures are positively associated with pathogen richness.
%
%
