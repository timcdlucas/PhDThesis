...
The independant variables were centered and scaled to allow direct comparison of the coefficients.
...
As seen in Figure~\ref{fig:fstITPlots}a, study effort is very likely in the best model ($\beta = $ 0.99, $Pr > $ 0.99) body mass and range size are also probably in the best model ($\beta = $ 0.48, $Pr = $ 0.8 and $\beta = $ 0.34, $Pr = $ 0.66).
...
Number of subspecies:log(Scholar) &  0.97 &  0.50 && \\[2mm]  
Gene flow & & &  0.89 &  0.005\\[2mm]  
log(Scholar) &  1.00 &  0.99 & 
   0.99 &  0.08\\
log(Mass) &  0.80 &  0.48 & 
   0.98 &  0.04\\
log(Range size) &  0.66 &  0.34& 
   0.06 &  0.59\\
Random &  0.20 &  0.05& 
   0.18 &  0.85\\
\bottomrule
