...
\begin{alltt}
\hlcom{# Models with species with only 1 virus removed}

\hlcom{# Unlogged subspecies variable}
\hlstd{unlogRm1.summary}
\end{alltt}
\begin{verbatim}
## 
## Call:
...
## -1.3198 -0.1851 -0.0146  0.1251  0.7060 
## 
...
\end{verbatim}
\begin{alltt}
\hlcom{# logged subspecies variable}
\hlstd{logRm1.summary}
\end{alltt}
\begin{verbatim}
## 
## Call:
...
## Residuals:
##     Min      1Q  Median      3Q     Max 
## -0.9779 -0.1740 -0.0276  0.1481  0.8049 
## 
## Branch length transformations:
## 
## kappa  [Fix]  : 1.000
