...
These two measures of population structure were analysed separately as the number of subspecies has 196 data points while there is only $F_{ST}$ data for 24 bat species.
...
The number of described virus  for a bat host raspeciesnged up to 15 viruses in \emph{Carollia perspicillata}.
