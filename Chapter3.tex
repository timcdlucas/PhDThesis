...
\caption[Pruned phylogeny \ref{} with dot size showing number of pathogens and colour showing family]{Pruned phylogeny \ref{} with dot size showing number of pathogens and colour showing family.}\label{fig:treePlot2}
\end{figure}
