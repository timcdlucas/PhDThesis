...
Both group size and the number of groups (i.e. components of population size) promote pathogen richness more than population density.
...
Dispersal can only occur between two colonies if they are within 100 kilometres of each other i.e. they are connected nodes in the metapopulation network.
