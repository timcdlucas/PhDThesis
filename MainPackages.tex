...
% A switcho turn on and off little subheaders that are for my readability.
%\newcommand{\tmpsection}[1]{\subsubsection{#1}}
\newcommand{\tmpsection}[1]{}


% Get the xelatex etc. logos
\usepackage{metalogo}



% make landscape tables available
\usepackage{lscape}

% multipage tables
\usepackage{longtable}

% Sideways tables with vertical captions.
\usepackage{rotating}

% allow control over tables
\usepackage{array}

% help align coefficients in tables.
%\usepackage{dcolumn}
