  ...
  \centering
{
  \subfloat[\label{f:signal}]{
    \includegraphics[width=0.45\textwidth]{imgs/AverageModelBias_callerror.pdf}
  } 
  \subfloat[\label{f:sensor}]{
    \includegraphics[width=0.45\textwidth]{imgs/AverageModelBias_cameraerror.pdf}
  } 
    
	\subfloat[\label{f:radius}]{
    \includegraphics[width=0.45\textwidth]{imgs/AverageModelBias_radiuserror.pdf}
  }%%
	\subfloat[\label{f:speed}]{
    \includegraphics[width=0.45\textwidth]{imgs/AverageModelBias_speederror.pdf}
  }
}%%
