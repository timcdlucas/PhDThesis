...
After \ensuremath{3\times 10^{3}} events, 10 individuals infected with disease 2 are added to one colony. 
After another \ensuremath{4.7\times 10^{4}} events the invasion of disease 2 is considered successful if any individuals with disease 2 still remain.
