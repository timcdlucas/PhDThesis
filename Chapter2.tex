...
\tmpsection{Metapopulation model}
...
The starting size of each colony was set to 3,000. 
...
The metapopulation contains 10 colonies.
...
Therefore exclusively juvenile dispersal would have dispersal rates similar to this value. %todo cite
