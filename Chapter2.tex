...
This was true at all transmission levels ($\chi^2$ test. $\beta = 2$: $\chi^2 = 4.19$, $\text{df} = 2$, $p = 0.12$. $\beta = 5$: $\chi^2 = 1.27$, $\text{df} = 2$, $p = 0.53$. $\beta = 10$: $\chi^2 = 0.01$, $\text{df} = 2$, $p = 1$).
...
This was true at all transmission levels ($\chi^2$ test. $\beta = 2$: $\chi^2 = 1.81$, $\text{df} = 1$, $p = 0.18$. $\beta = 5$: $\chi^2 = 0.62$, $\text{df} = 1$, $p = 0.43$. $\beta = 10$: $\chi^2 = 2.65$, $\text{df} = 1$, $p = 0.1$).
...
However, the results are the same as above if these simulations are removed from the analysis ($\chi^2$ test. $\beta = 2$: $\chi^2 = 2.29$, $\text{df} = 1$, $p = 0.13$. $\beta = 5$: $\chi^2 = 0.15$, $\text{df} = 1$, $p = 0.7$. $\beta = 10$: $\chi^2 = 2.36$, $\text{df} = 1$, $p = 0.12$).
...
This is true for all three dispersal values ($\chi^2$ test. $\lambda = 0.001$: $\chi^2 = 19.35$, $\text{df} = 2$, $p = \ensuremath{6.27\times 10^{-5}}$. $\lambda = 0.01$: $\chi^2 = 29.05$, $\text{df} = 2$, $p = \ensuremath{4.92\times 10^{-7}}$. $\lambda = 0.1$: $\chi^2 = 38.9$, $\text{df} = 2$, $p = \ensuremath{3.56\times 10^{-9}}$) and both network structures ($\chi^2$ test. Fully connected: $\chi^2 = 66.4$, $\text{df} = 2$, $p =\ensuremath{3.81\times 10^{-15}}$. Minimally connected: $\chi^2 =  66.4$, $\text{df} = 2$, $p = \ensuremath{3.81\times 10^{-15}}$).


\ensuremath{3.81\times 10^{-5}}
...
$n, m$ & Colony index &&\\
$A_{mn}$ & Adjacency matrix. & Distance &\\
