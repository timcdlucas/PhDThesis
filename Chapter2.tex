...
$\Lambda$ & Birth rate & Births per year per individual& 0.05\\
$\mu$ & Death rate & Deaths per year per individual & 0.05\\
...
The death rate $\mu$ is set as 0.05 per year giving a generation time of 20 years.
The birth rate $\Lambda$ is set to be equal to $\mu$ so that the population size is stable.
