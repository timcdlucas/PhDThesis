...
One commonly taken assumption in the ecological literature is that factors that promote high disease spread automatically promotes high diversity; this is contrary to the predictions from analytical models \cite{qiu2013vector, allen2004sis, nunes2006localized}. 
...
\tmpsection{Population structure does not affect pathogen richness}
...
\tmpsection{Dispersal does not affect pathogen richness}

Irrespective of the network topology used, at very high dispersal rates a population will be well mixed.


\tmpsection{Network connectedness does not affect pathogen richness}
