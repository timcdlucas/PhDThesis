...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prop.test(invsDisp\$n[c(3, 6, 9)], nDisp\$n[c(3, 6, 9)]): elements of 'x' must not be greater than those of 'n'}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in prop.test(invsTopo2\$n[5:6], nTopo2\$n[5:6]): not enough data}}\end{kframe}
\end{knitrout}
