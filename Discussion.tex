...
This includes populations where epidemic cycles are common; subsequent to a large epidemic, and after a time lag, the number of susceptible individuals in the populations will be low due to immunity, host death or low birth rates induced by infection \cite{}.
This effect will be exacerbated in the case where an epidemic cycle is synchronous across the whole population.
...
Roost sharing and the amount of sympatry has been included in empirical studies of bat pathogen richness \cite{} %todo, was it found to be important.

Finally, birth and deaths have been modelled here as occuring randomly through time but many bat species have very tightly controlled birth pulses \cite{}.
