...
%this seems largely just a restatement of the chapters in detail - i think some overview is needed to summarise everything but then you need to move on and pull threads out that are common to all these chapters and discuss these in a wider way. For example, what mechanism could explain the results of population structure if not pathogen invasion - is that likely - what further work is needed to show this?
