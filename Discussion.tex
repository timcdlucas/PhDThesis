...
Field tests should test its ability to estimate population size and density and to ensure it is not strongly biased by species specific factors; only if it is unbiased can it be effectively used in predictive models and other applications.
...
Furthermore, I have shown that while population factors such as population size, density and range size are directly linked, they have very different affects on pathogen richness.
