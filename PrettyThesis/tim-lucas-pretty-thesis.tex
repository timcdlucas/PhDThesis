...
\unidegree{Doctor of Philosophy}
\university{University College London -- Centre for Mathematics and Physics in the Life Sciences and Experimental Biology}
...
% biblatex does bibs like this.
% This didn't work, so copied epilit to this folder instead.
...
% The fact that \input is the last thing before this ensures that it
